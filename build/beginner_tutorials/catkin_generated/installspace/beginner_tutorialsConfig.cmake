...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/sophie/Documents/FRC2017/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/sophie/Documents/FRC2017/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/sophie/Documents/FRC2017/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Your Name <you@yourdomain.tld>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sophie/Documents/FRC2017/install/${idir}'.  Ask the maintainer 'Your Name <you@yourdomain.tld>' to fix it.")
    endif()
