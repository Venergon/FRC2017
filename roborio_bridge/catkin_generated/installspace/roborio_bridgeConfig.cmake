...
if("FALSE" STREQUAL "TRUE")
  ...
  set(roborio_bridge_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roborio_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Your Name <you@yourdomain.tld>' to fix it.")
    endif()
